...
"));
  ...
  class BenchPlant "COST Benchmark WWTP Configuration"
    ...
    WasteWater.ASM1.aeration_energy aeration_energy
      annotation (Placement(transformation(extent={{-9,55},{11,75}})));
  ...
  equation
    ...
    connect(tank5.Kla_output, aeration_energy.Kla5) annotation (Line(
        points={{3.8,7},{4,7},{4,54.2},{3.4,54.2}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(tank3.Kla_output, aeration_energy.Kla3) annotation (Line(
        points={{-50.2,7},{-27,7},{-27,38},{-1.4,38},{-1.4,54.2}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(tank4.Kla_output, aeration_energy.Kla4) annotation (Line(
        points={{-23.2,7},{-11,7},{-11,37},{1,37},{1,54.2}},
        color={0,0,127},
        smooth=Smooth.None));
